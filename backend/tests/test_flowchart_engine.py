...
from services.ai.flowchart_nodes import (
    StartNode, EndNode, DecisionNode, ActionNode, MultiDecisionNode,
...
from services.ai.optimization_strategies import BaseMaltIncreaseStrategy, NormalizeAmountsStrategy
...
class TestFlowchartNodes:
    ...
    def test_action_node_execution(self):
        ...
        context.execute_strategy.assert_called_once_with('test_strategy', {'param1': 'value1'})
...
class TestRecipeContext:
    ...
    def test_recipe_context_initialization(self, sample_recipe_data, sample_style_guidelines):
...
class TestFlowchartEngine:
    ...
    def test_workflow_execution_no_changes_needed(self, simple_workflow_config, sample_recipe_data):
    ...
    def test_workflow_execution_with_changes(self, simple_workflow_config, sample_recipe_data):
...
class TestOptimizationStrategies:
    ...
    def test_base_malt_increase_strategy(self, sample_recipe_data, sample_style_guidelines):
