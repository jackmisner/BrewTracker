...
class FlowchartAIService:
    ...
    def analyze_recipe(self, 
        ...
        try:
            ...
            logger.error(f"FlowchartAIService analyze_recipe failed: {e}", exc_info=True)
            raise
    ...
    def get_suggestions(self,
                       ...
                       unit_system: str = "imperial") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error(f"FlowchartAIService get_suggestions failed: {e}", exc_info=True)
            raise
    ...
    def calculate_effects(self,
        ...
        try:
            ...
            logger.error(f"FlowchartAIService calculate_effects failed: {e}", exc_info=True)
            raise
    ...
    def _convert_workflow_result_to_api_format(self, 
                                             workflow_result: WorkflowResult,
                                             original_recipe: Dict[str, Any],
                                             style_analysis: Optional[Dict[str, Any]],
                                             unit_system: str) -> Dict[str, Any]:
        """
        ...
        if optimization_performed:
            ...
            return {
                'current_metrics': optimization_summary.get('metrics_before', workflow_result.final_metrics),
                ...
                'recipe_changes': self._convert_changes_to_api_format(workflow_result.changes),
                'optimization_history': [{
                    'iteration': 1,
                    'applied_changes': workflow_result.changes,
                    'metrics_before': optimization_summary.get('metrics_before', {}),
    ...
    def _apply_changes_to_recipe(self, 
                               original_recipe: Dict[str, Any],
                               changes: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _convert_changes_to_api_format(self, changes: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for change in changes:
            ...
            if change.get('type') == 'ingredient_added':
                api_change.update({
                    'ingredient_type': change.get('ingredient_data', {}).get('type', ''),
