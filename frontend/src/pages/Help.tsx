      ...
      <div className="content-container">
        ...
        <div className="card">
          ...
          <div className="content-section">
            ...
            <ol>
              <li>
                Navigate to <strong>Recipes</strong> in the main menu
              </li>
              <li>
                Click <strong>+ New Recipe</strong>
              </li>
              <li>
                Fill in basic recipe information (name, style, batch size)
              </li>
        ...
        <div className="card">
          ...
          <div className="content-section">
            ...
            <ul>
              <li>
                <strong>View:</strong> See complete recipe details and
                calculations
              </li>
              <li>
                <strong>Edit:</strong> Modify ingredients and recipe information
              </li>
              <li>
                <strong>Clone:</strong> Create a copy to experiment with
                variations
              </li>
              <li>
                <strong>Brew:</strong> Start a new brew session from this recipe
              </li>
            </ul>

            <h3>Recipe Versioning</h3>
            <p>
              When you clone a recipe, BrewTracker creates a linked version.
              This helps you track recipe evolution and compare different
              iterations.
            </p>

            <h3>Public vs Private Recipes</h3>
            <p>
              You can share recipes with the community by making them public, or
              keep them private for personal use. Public recipes can be cloned
              by other users.
            </p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="content-section">
            ...
            <ul>
              <li>
                <strong>OG (Original Gravity):</strong> Starting sugar content
              </li>
              <li>
                <strong>FG (Final Gravity):</strong> Ending sugar content after
                fermentation
              </li>
              <li>
                <strong>ABV (Alcohol By Volume):</strong> Alcohol percentage
              </li>
              <li>
                <strong>IBU (International Bitterness Units):</strong> Hop
                bitterness
              </li>
              <li>
                <strong>SRM (Standard Reference Method):</strong> Beer color
              </li>
            </ul>
        ...
        <div className="card">
          ...
          <div className="content-section">
            ...
            <p>Brew sessions help you track the journey from grain to glass:</p>
            <ul>
            ...
            <ul>
              <li>
                <strong>Planned:</strong> Ready to brew
              </li>
              <li>
                <strong>In Progress:</strong> Currently brewing
              </li>
              <li>
                <strong>Fermenting:</strong> Primary fermentation
              </li>
              <li>
                <strong>Conditioning:</strong> Secondary/bottle conditioning
              </li>
              <li>
                <strong>Completed:</strong> Ready to drink
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="content-section">
            ...
            <p>
              BrewTracker's AI system can analyze your recipes and suggest
              improvements to meet specific beer style guidelines:
            </p>
            <ul>
        ...
        <div className="card">
          ...
          <div className="content-section">
            ...
            <p>
              Import recipes from other brewing software or export your
              BrewTracker recipes in the standard BeerXML format.
            </p>

            <h3>Yeast Attenuation Analytics</h3>
            <p>
              Track real-world yeast performance data to improve fermentation
              predictions and recipe planning.
            </p>

            <h3>Ingredient Management</h3>
            <p>
              Browse and search through a comprehensive database of brewing
              ingredients, including detailed specifications for malts, hops,
              and yeasts.
            </p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="content-section">
            <p>If you can't find what you're looking for in this guide:</p>
            <ul>
              <li>
                Check the <a href="/faq">FAQ</a> for common questions
              </li>
              <li>
                Report bugs using our <a href="/report-bug">Bug Report</a> form
              </li>
              <li>
              ...
              <li>
                Contact us through the <a href="/about">About</a> page
              </li>
            </ul>
          </div>
        </div>
