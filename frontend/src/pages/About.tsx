      ...
      <div className="content-container">
        <div className="card">
          ...
          <div className="content-section">
            <h2>Hello! 👋</h2>
            <p>
              I'm Jack Misner, a software developer and homebrewing enthusiast
              who created BrewTracker to solve a personal problem: keeping track
              of recipes, brewing sessions, and all the calculations that go
              into making great beer.
            </p>
            ...
            <div className="about-photo-section">
              ...
              <p className="photo-caption">
                Enjoying traditional German beer - experiences like this fueled
                my passion for brewing and inspired me to create better tools
                for fellow beer enthusiasts! 🍺
              </p>
            </div>
            ...
            <p>
              ...
              manage my homebrew recipes and track my brewing sessions. I wanted
              a single, comprehensive tool that could:
            </p>
            <ul>
              <li>
            ...
            <div className="about-photo-section">
              ...
              <p className="photo-caption">
                ...
                successes that highlighted the need for better recipe management
                and tracking tools. The journey from this batch to BrewTracker
                spans nearly a decade of brewing passion!
              </p>
            </div>

            <h2>Technology & Approach 💻</h2>
            <p>
              BrewTracker is built with modern web technologies including React,
              TypeScript, Flask, and MongoDB. The application focuses on
              accuracy, usability, and respect for brewing science. All
              calculations are based on established brewing formulas and
              industry standards.
            </p>
            ...
            <p>
              I believe in giving back to the brewing and developer communities
              that have taught me so much. Contributions, feedback, and feature
              requests are always welcome!
            </p>

            <h2>Get In Touch 📧</h2>
            <p>
              Whether you want to discuss brewing, code, or just say hello, feel
              free to reach out:
            </p>
            <ul>
              <li>
              ...
              <li>
                <a href="mailto:jack@brewtracker.co.uk">
                  jack@brewtracker.co.uk
                </a>
              </li>
            </ul>
