...
describe("BeerStyleService", () => {
  ...
  describe("fetchBeerStyles", () => {
    test("fetches and caches beer styles", async () => {
      ApiService.beerStyles.getAll.mockResolvedValue({
    ...
    test("handles API errors gracefully", async () => {
      ApiService.beerStyles.getAll.mockRejectedValue(new Error("API Error"));
  ...
  describe("searchBeerStyles", () => {
    test("searches beer styles successfully", async () => {
      ...
      ApiService.beerStyles.search.mockResolvedValue({
    ...
    test("handles search errors gracefully", async () => {
      ApiService.beerStyles.search.mockRejectedValue(new Error("Search Error"));
  ...
  describe("getBeerStyle", () => {
    test("fetches a specific beer style", async () => {
      ApiService.beerStyles.getById.mockResolvedValue({
    ...
    test("handles errors when fetching specific style", async () => {
      ApiService.beerStyles.getById.mockRejectedValue(new Error("Not Found"));
  ...
  describe("getStyleSuggestions", () => {
    test("fetches style suggestions for a recipe", async () => {
      ApiService.beerStyles.getStyleSuggestions.mockResolvedValue({
    ...
    test("handles errors when fetching style suggestions", async () => {
      ApiService.beerStyles.getStyleSuggestions.mockRejectedValue(
        new Error("API Error")
      );
  ...
  describe("getRecipeStyleAnalysis", () => {
    test("fetches recipe style analysis", async () => {
      ApiService.beerStyles.getRecipeStyleAnalysis.mockResolvedValue({
    ...
    test("handles errors when fetching style analysis", async () => {
      ApiService.beerStyles.getRecipeStyleAnalysis.mockRejectedValue(
        new Error("API Error")
      );
