...
describe("UserSettingsService", () => {
  ...
  beforeEach(() => {
    ...
    ApiService.user.getSettings.mockResolvedValue(sampleApiResponse);
    ApiService.user.updateSettings.mockResolvedValue(sampleApiResponse);
    ApiService.user.updateProfile.mockResolvedValue(sampleApiResponse);
    ApiService.user.changePassword.mockResolvedValue({
      data: { success: true },
    });
    ApiService.user.deleteAccount.mockResolvedValue({
      data: { success: true },
    });
  });
  ...
  describe("getUserSettings", () => {
    ...
    it("handles API errors gracefully", async () => {
      ...
      ApiService.user.getSettings.mockRejectedValue(apiError);
    ...
    it("handles completely missing data", async () => {
      ApiService.user.getSettings.mockResolvedValue({ data: {} });
  ...
  describe("updateSettings", () => {
    ...
    it("handles API errors during update", async () => {
      ...
      ApiService.user.updateSettings.mockRejectedValue(apiError);
    ...
    it("handles server validation errors", async () => {
      ...
      ApiService.user.updateSettings.mockRejectedValue(serverError);
  ...
  describe("updateProfile", () => {
    ...
    it("updates cached user data after successful update", async () => {
      ...
      ApiService.user.updateProfile.mockResolvedValue(newUserData);

      await UserSettingsService.updateProfile(profileUpdate);

      // Check that cache was updated
      expect(UserSettingsService.settingsCache.user.username).toBe(
        "newusername"
      );
    });
    ...
    it("handles API errors during profile update", async () => {
      ...
      ApiService.user.updateProfile.mockRejectedValue(apiError);
  ...
  describe("changePassword", () => {
    ...
    it("handles API errors during password change", async () => {
      ...
      ApiService.user.changePassword.mockRejectedValue(apiError);
  ...
  describe("deleteAccount", () => {
    ...
    it("clears cache after successful deletion", async () => {
      // Populate cache first
      await UserSettingsService.getUserSettings();
      expect(UserSettingsService.settingsCache).not.toBeNull();

      await UserSettingsService.deleteAccount(confirmationData);

      expect(UserSettingsService.settingsCache).toBeNull();
      expect(UserSettingsService.cacheTimestamp).toBeNull();
    });
    ...
    it("handles API errors during account deletion", async () => {
      ...
      ApiService.user.deleteAccount.mockRejectedValue(apiError);
  ...
  describe("cache management", () => {
    ...
    it("clearCache removes cache and timestamp", async () => {
      ...
      expect(UserSettingsService.settingsCache).not.toBeNull();
      expect(UserSettingsService.cacheTimestamp).not.toBeNull();
  ...
  describe("singleton behavior", () => {
    it("maintains state across imports", async () => {
      ...
      expect(AnotherInstance.settingsCache).not.toBeNull();
  ...
  describe("edge cases and error scenarios", () => {
    it("handles null API response", async () => {
      ApiService.user.getSettings.mockResolvedValue({ data: null });

      await expect(UserSettingsService.getUserSettings()).rejects.toThrow();
    });

    it("handles undefined API response", async () => {
      ApiService.user.getSettings.mockResolvedValue({ data: undefined });
    ...
    it("handles network timeout", async () => {
      ...
      ApiService.user.getSettings.mockRejectedValue(timeoutError);
