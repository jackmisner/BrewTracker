...
describe("PublicRecipes", () => {
  ...
  beforeEach(() => {
    ...
    ApiService.recipes.getPublic.mockResolvedValue({
      data: {
  ...
  describe("Initial render and loading", () => {
    ...
    it("shows loading state initially", () => {
      ApiService.recipes.getPublic.mockImplementation(() =>
        scenarios.loading()
      );
  ...
  describe("Error handling", () => {
    it("displays error message when API fails", async () => {
      ApiService.recipes.getPublic.mockRejectedValue(new Error("API Error"));
    ...
    it("logs error to console when API fails", async () => {
      ...
      ApiService.recipes.getPublic.mockRejectedValue(
  ...
  describe("Style filtering", () => {
    it("updates style filter when option is selected", () => {
      ...
      expect(styleSelect.value).toBe("IPA");
    });
  ...
  describe("Recipe cloning", () => {
    ...
    it("shows alert when clone fails", async () => {
      ...
      ApiService.recipes.clone.mockRejectedValue(new Error("Clone failed"));
