...
describe("Dashboard", () => {
  ...
  test("renders loading state initially", () => {
    ApiService.recipes.getAll.mockImplementation(() => new Promise(() => {}));
    ApiService.brewSessions.getAll.mockImplementation(
      () => new Promise(() => {})
    );
  ...
  test("handles empty recipes state", async () => {
    ApiService.recipes.getAll.mockResolvedValue({ data: { recipes: [] } });
    ApiService.brewSessions.getAll.mockResolvedValue(mockSessionsResponse);
  ...
  test("handles API errors", async () => {
    ...
    ApiService.recipes.getAll.mockRejectedValue(new Error("API Error"));
