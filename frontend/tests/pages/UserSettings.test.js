...
jest.mock("../../src/contexts/UnitContext", () => ({
  ...
  UnitProvider: ({ children }) => <div>{children}</div>,
}));
...
describe("UserSettings", () => {
  ...
  beforeEach(() => {
    ...
    UserSettingsService.getUserSettings.mockResolvedValue(sampleUserSettings);
    UserSettingsService.updateProfile.mockResolvedValue({});
    UserSettingsService.changePassword.mockResolvedValue({});
    UserSettingsService.updateSettings.mockResolvedValue({});
    UserSettingsService.deleteAccount.mockResolvedValue({});
  ...
  describe("Initial render and loading", () => {
    it("shows loading state initially", () => {
      UserSettingsService.getUserSettings.mockImplementation(() =>
        scenarios.loading()
      );
  ...
  describe("Error handling", () => {
    it("displays error message when settings fail to load", async () => {
      UserSettingsService.getUserSettings.mockRejectedValue(
        new Error("API Error")
      );
  ...
  describe("Account tab - Profile form", () => {
    ...
    it("handles profile update error", async () => {
      UserSettingsService.updateProfile.mockRejectedValue(
    ...
    it("shows saving state during profile update", async () => {
      UserSettingsService.updateProfile.mockImplementation(() =>
        scenarios.loading()
      );
  ...
  describe("Preferences tab - Form submission", () => {
    ...
    it("handles preferences update error", async () => {
      UserSettingsService.updateSettings.mockRejectedValue(
  ...
  describe("Security tab - Password change", () => {
    ...
    it("handles password change error", async () => {
      UserSettingsService.changePassword.mockRejectedValue(
  ...
  describe("Security tab - Account deletion", () => {
    ...
    it("handles account deletion error", async () => {
      mockConfirm.mockReturnValue(true);
      UserSettingsService.deleteAccount.mockRejectedValue(
