...
describe("IngredientManager", () => {
  ...
  beforeEach(() => {
    ...
    ApiService.ingredients.getAll.mockResolvedValue({
      data: mockIngredients,
    });

    ingredientServiceInstance.groupIngredientsByType.mockReturnValue(
  ...
  describe("Initial render and loading", () => {
    ...
    it("handles API error during initial load", async () => {
      ApiService.ingredients.getAll.mockRejectedValue(new Error("API Error"));
  ...
  describe("Form submission", () => {
    it("submits valid grain ingredient successfully", async () => {
      ApiService.ingredients.create.mockResolvedValue({});
      ApiService.ingredients.getAll.mockResolvedValue({
    ...
    it("shows loading state during submission", async () => {
      ...
      ApiService.ingredients.create.mockImplementation(
    ...
    it("handles submission error", async () => {
      ApiService.ingredients.create.mockRejectedValue(
  ...
  describe("Ingredient display", () => {
    ...
    it("shows empty state when no ingredients exist", async () => {
      ApiService.ingredients.getAll.mockResolvedValue({ data: [] });
      ingredientServiceInstance.groupIngredientsByType.mockReturnValue({
        grain: [],
        hop: [],
        yeast: [],
  ...
  describe("Edge cases and error scenarios", () => {
    ...
    it("handles missing ingredient service", async () => {
      ingredientServiceInstance.groupIngredientsByType.mockImplementation(
        () => {
