...
describe("FermentationTracker", () => {
  ...
  describe("Loading State", () => {
    it("should show loading message initially", () => {
      ApiService.brewSessions.getFermentationData.mockReturnValue(
        new Promise(() => {}) // Never resolves
      );
      ApiService.brewSessions.getFermentationStats.mockReturnValue(
        new Promise(() => {}) // Never resolves
      );
  ...
  describe("Error Handling", () => {
    ...
    it("should show error message when adding entry fails", async () => {
      ApiService.brewSessions.addFermentationEntry.mockRejectedValue(
    ...
    it("should show error message when delete fails", async () => {
      ApiService.brewSessions.deleteFermentationEntry.mockRejectedValue(
  ...
  describe("Form Interactions", () => {
    it("should show/hide form when add entry button is clicked", async () => {
      ...
      renderWithProviders(<FermentationTracker {...propsWithoutOG} />);
    ...
    it("should handle form field changes", async () => {
      ...
      expect(gravityInput.value).toBe("1.050");
      expect(temperatureInput.value).toBe("68.5");
      expect(phInput.value).toBe("4.2");
    ...
    it("should submit form with correct data", async () => {
      ...
      await waitFor(() => {
        expect(
          ApiService.brewSessions.addFermentationEntry
    ...
    it("should reset form after successful submission", async () => {
      ...
      await waitFor(() => {
        expect(ApiService.brewSessions.addFermentationEntry).toHaveBeenCalled();
      });
    ...
    it("should show submitting state during form submission", async () => {
      ApiService.brewSessions.addFermentationEntry.mockReturnValue(
  ...
  describe("Auto OG Setting", () => {
    it("should auto-populate gravity and show form when session has actual_og but no fermentation data", async () => {
      ...
      renderWithProviders(<FermentationTracker {...propsWithOG} />);
      ...
      await waitFor(() => {
        ...
        const gravityInput = screen.getByLabelText("Gravity");
        expect(gravityInput.value).toBe("1.055");
      });
    });
    ...
    it("should not auto-show form if not in fermenting status", async () => {
      ...
      renderWithProviders(<FermentationTracker {...propsWithPlannedStatus} />);
    ...
    it("should not auto-show form when fermentation data already exists", async () => {
      ...
      renderWithProviders(<FermentationTracker {...propsWithDataAndOG} />);
  ...
  describe("Session Updates", () => {
    it("should update session with actual_og if first entry and session has no OG", async () => {
      ApiService.brewSessions.getFermentationData.mockResolvedValue({
        data: [], // No existing fermentation data
      });
    ...
    it("should calculate and set FG when gravity stabilizes", async () => {
      ...
      renderWithProviders(<FermentationTracker {...propsForFG} />);
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle empty recipe data", async () => {
      ...
      renderWithProviders(<FermentationTracker {...propsWithoutRecipe} />);
  ...
  describe("API Integration", () => {
    it("should call all required API endpoints on component mount", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          ApiService.brewSessions.getFermentationStats
        ).toHaveBeenCalledWith("test-session-id");
      });
    });
