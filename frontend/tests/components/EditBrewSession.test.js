...
describe("EditBrewSession", () => {
  ...
  describe("Form Rendering", () => {
    it("renders form with fetched session data", async () => {
      ...
      await waitFor(() => {
        ...
        expect(mashTempInput).toHaveValue(mockSession.mash_temp);
  ...
  describe("Form Submission", () => {
    it("disables form controls while submitting", async () => {
      BrewSessionService.updateBrewSession.mockReturnValue(
    ...
    it("properly formats and submits data when form is submitted", async () => {
      ...
      BrewSessionService.updateBrewSession.mockResolvedValue(mockSession);
      ...
      await waitFor(() => {
        ...
        const updateCall =
          BrewSessionService.updateBrewSession.mock.calls[0][1];
  ...
  describe("Edge Cases", () => {
    it("handles session with missing optional fields", async () => {
      ...
      BrewSessionService.fetchBrewSession.mockResolvedValue(minimalSession);
