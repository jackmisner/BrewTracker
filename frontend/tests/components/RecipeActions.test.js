...
describe("RecipeActions", () => {
  ...
  test("handles successful recipe cloning", async () => {
    ...
    ApiService.recipes.clone.mockResolvedValue(mockCloneResponse);
  ...
  test("handles clone error", async () => {
    ...
    ApiService.recipes.clone.mockRejectedValue(mockError);
  ...
  test("shows loading state during cloning", async () => {
    ...
    ApiService.recipes.clone.mockImplementation(
  ...
  test("handles recipe deletion with confirmation", async () => {
    ...
    ApiService.recipes.delete.mockResolvedValue();
  ...
  test("handles delete error", async () => {
    ...
    ApiService.recipes.delete.mockRejectedValue(mockError);
  ...
  test("shows loading state during deletion", async () => {
    ...
    ApiService.recipes.delete.mockImplementation(
      () => new Promise(() => {}) // Never resolves
    );
