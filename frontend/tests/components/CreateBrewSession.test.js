...
describe("CreateBrewSession", () => {
  ...
  describe("Loading State", () => {
    it("should show loading message initially", () => {
      RecipeService.fetchRecipe.mockReturnValue(new Promise(() => {})); // Never resolves
  ...
  describe("Successful Recipe Loading", () => {
    ...
    it("should pre-populate session name with recipe name and current date", async () => {
      ...
      await waitFor(() => {
        ...
        expect(sessionNameInput.value).toMatch(
  ...
  describe("Form Interactions", () => {
    it("should update session name when changed", async () => {
      ...
      await waitFor(() => {
        ...
        expect(sessionNameInput.value).toBe("My Custom Session Name");
      });
    });
    ...
    it("should update brew date when changed", async () => {
      ...
      await waitFor(() => {
        ...
        expect(brewDateInput.value).toBe("2024-12-25");
      });
    });
    ...
    it("should update notes when changed", async () => {
      ...
      await waitFor(() => {
        ...
        expect(notesTextarea.value).toBe("These are my brew notes");
      });
    });
  });
  ...
  describe("Form Submission", () => {
    beforeEach(() => {
      BrewSessionService.createBrewSession.mockResolvedValue(mockBrewSession);
    });
    ...
    it("should show creating state during submission", async () => {
      ...
      BrewSessionService.createBrewSession.mockReturnValue(
        new Promise((resolve) =>
  ...
  describe("Form Submission Errors", () => {
    it("should show error message when submission fails", async () => {
      BrewSessionService.createBrewSession.mockRejectedValue(
  ...
  describe("Edge Cases", () => {
    it("should handle recipe with missing optional fields", async () => {
      ...
      RecipeService.fetchRecipe.mockResolvedValue(minimalRecipe);
